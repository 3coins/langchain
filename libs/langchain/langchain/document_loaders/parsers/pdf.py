...
class AmazonTextractPDFParser(BaseBlobParser):
    ...
    multi-page documents have to reside on S3, single page PDF can be on local file system
    multi-page documents that do not reside on S3 will throw an ValueError
    """
    ...
    def __init__(self, textract_features:list[tc.Textract_Features]=[], boto3_textract_client=None) -> None:
        self.textract_features = textract_features
        self.boto3_textract_client = boto3_textract_client
